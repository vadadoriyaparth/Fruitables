...
function Contact(props) {
  let contectSchema = object({
    ...
    message: string().required().min(5, "Atlaste 5 charector long message."),
  });
            ...
            <div className="row g-4">
              <div className="col-12">
                <div className="text-center mx-auto" style={{ maxWidth: 700 }}>
                  ...
                  <h3 className="mb-4">The contact form is currently inactive. Get a functional and working contact form with Ajax &amp; PHP in a few minutes. Just copy and paste the files, add a little code and you're done. <a href="https://htmlcodex.com/contact-form">Download Now</a>.</h3>
                </div>
              </div>
              ...
              <div className="col-lg-7">
                <form onSubmit={handleSubmit}>
                  ...
                  <span className='errorMessage'style={{color:'red'}}>{errors.email && touched.email ? errors.email : ''}</span><br />
                  ...
                  <textarea
                    ...
                    onBlur={handleBlur}
                  />
                  <span className='errorMessage'style={{color:'red'}} >{errors.message && touched.message ? errors.message : ''}</span><br />
              ...
              <div className="col-lg-5">
                <div className="d-flex p-4 rounded mb-4 bg-white">
                  ...
                  <div>
                    <h3>Address</h3>
                    <h3 className="mb-2">123 Street New York.USA</h3>
                  </div>
                </div>
                <div className="d-flex p-4 rounded mb-4 bg-white">
                  ...
                  <div>
                    <h3>Mail Us</h3>
                    <h3 className="mb-2">info@example.com</h3>
                  </div>
                </div>
                <div className="d-flex p-4 rounded bg-white">
                  ...
                  <div>
                    <h3>Telephone</h3>
                    <h3 className="mb-2">(+012) 3456 7890</h3>
                  </div>
                </div>
              </div>
            </div>
