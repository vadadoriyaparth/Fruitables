...
import { shopditailsget } from '../../../redux/action/shopdetail.action';
...
function Shop_detail(props) {
  ...
  useEffect(() => {
    dispatch(shopditailsget());     
  }, []);

  const shopdi = useSelector(state => state.shopdi);
  console.log(shopdi);
                ...
                <div className="row g-4">
                  <div className="col-lg-6">
                    <div className="border rounded">
                      <a href="#">
                        <img src={`../${products?.image}`} className="img-fluid rounded" alt="Image" />
                      </a>
                    </div>
                  </div>
                  <div className="col-lg-6">
                    ...
                    <div className="input-group quantity mb-5" style={{ width: 100 }}>
                      <div className="input-group-btn">
                        <button className="btn btn-sm btn-minus rounded-circle bg-light border" onClick={() =>handeldencrement (id)}>
                      ...
                      <div className="input-group-btn">
                        <button className="btn btn-sm btn-plus rounded-circle bg-light border" onClick={()=>handelincrement(id)}>
              ...
              <div className="col-lg-4 col-xl-3">
                <div className="row g-4 fruite">
                  ...
                  <div className="col-lg-12">
                    ...
                    <div className="d-flex align-items-center justify-content-start">
                      <div className="rounded" style={{ width: 100, height: 100 }}>
                        <img src={`../${products?.image}`} className="img-fluid rounded" alt />
                      </div>
                      <div>
                        <h6 className="mb-2">Big Banana</h6>
                        <div className="d-flex mb-2">
                  ...
                  <div className="col-lg-12">
                    <div className="position-relative">
                      <img src={`../${products?.image}`} className="img-fluid w-100 rounded" alt />
